{
  ...
  "Commands": [
    ...
    {
      "Command": "store",
      "Target": "-BBKK = ${ARRAYRESULT[10]} -KKBB = ${ARRAYRESULT[11]} -KBKB = ${ARRAYRESULT[12]} -BKBK = ${ARRAYRESULT[13]} -GGJJ = ${ARRAYRESULT[14]} -JJGG = ${ARRAYRESULT[15]} -GJGJ = ${ARRAYRESULT[16]} -JGJG = ${ARRAYRESULT[16]}",
      "Value": "XCEK_POLA"
    },
    {
      "Command": "store",
      "Target": "-BBKK = ${ARRAYRESULT[18]} -KKBB = ${ARRAYRESULT[19]} -GGJJ = ${ARRAYRESULT[20]} -JJGG = ${ARRAYRESULT[21]} ",
      "Value": "XCEK_POLA_GAGAL"
    },
    {
      "Command": "if_v2",
